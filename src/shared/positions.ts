...
const TRAVELING: Positions = {
    [PLACES.ENTRANCE]: {
        [PLACES.BENCH]: [CAMERA_START_POSITION, new THREE.Vector3(-7, 1.5, 0.6), new THREE.Vector3(-5, 1.5, 5), new THREE.Vector3(-3, 1.5, 7), new THREE.Vector3(-0.5, 1.5, 8), new THREE.Vector3(0, 1.5, 9)],
