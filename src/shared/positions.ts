...
const HOUSE_DESTINATION: Destination = { name: "Museum", position: PLACES.MUSEUM, icon: "museum", color: "#B07A7A" };
...
const LAKE_HOUSE_DESTINATION: Destination = { name: "Lake", position: PLACES.LAKE.MUSEUM, icon: "lake", color: "#559A9A" };
...
export const DESTINATIONS: Destinations = {
    ...
    [PLACES.MUSEUM]: [BENCH_DESTINATION, PATH_DESTINATION, LAKE_HOUSE_DESTINATION],
    ...
    [PLACES.LAKE.MUSEUM]: [BENCH_DESTINATION, PATH_DESTINATION, HOUSE_DESTINATION],
};
...
export const ISS_POSITION = BENCH_POSITION.clone().add(new THREE.Vector3(-0.5, 0.75, 0.75));
export const ISS_ROTATION = new THREE.Euler(80, 15, 10, "XYZ");
...
export const TRAVELLING: Positions = {
    [PLACES.ENTRANCE]: {
        ...
        [PLACES.MUSEUM]: [CAMERA_START_POSITION.clone(), new THREE.Vector3(-7.4, 1.5, 0.6), new THREE.Vector3(-1.9, 1.5, 8.15), CAMERA_HOUSE_POSITION.clone()],
    ...
    [PLACES.BENCH]: {
        ...
        [PLACES.MUSEUM]: [CAMERA_BENCH_POSITION.clone(), new THREE.Vector3(3.6, 1.5, 5), CAMERA_HOUSE_POSITION.clone()],
    ...
    [PLACES.PATH]: {
        ...
        [PLACES.MUSEUM]: [CAMERA_PATH_POSITION.clone(), new THREE.Vector3(1.65, 1.5, -4.9), CAMERA_HOUSE_POSITION.clone()],
    ...
    [PLACES.MUSEUM]: {
        ...
        [PLACES.LAKE.MUSEUM]: [CAMERA_HOUSE_POSITION.clone(), CAMERA_LAKE_HOUSE_POSITION.clone()],
    },
    [PLACES.LAKE.ENTRANCE]: {
        ...
        [PLACES.MUSEUM]: [CAMERA_LAKE_ENTRANCE_POSITION.clone(), new THREE.Vector3(0.1, 1.5, -5.4), CAMERA_HOUSE_POSITION.clone()],
    },
    [PLACES.LAKE.BENCH]: {
        ...
        [PLACES.MUSEUM]: [CAMERA_LAKE_BENCH_POSITION.clone(), CAMERA_HOUSE_POSITION.clone()],
    },
    [PLACES.LAKE.PATH]: {
        ...
        [PLACES.MUSEUM]: [CAMERA_LAKE_PATH_POSITION.clone(), CAMERA_HOUSE_POSITION.clone()],
    },
    [PLACES.LAKE.MUSEUM]: {
        ...
        [PLACES.MUSEUM]: [CAMERA_LAKE_HOUSE_POSITION.clone(), CAMERA_HOUSE_POSITION.clone()],
    },
};
...
export const CONTROL_POINTS: Positions = {
    [PLACES.ENTRANCE]: {
        ...
        [PLACES.MUSEUM]: [CAMERA_START_POSITION.clone(), new THREE.Vector3(-9.3, 1.5, -0.3), new THREE.Vector3(-5.8, 1.5, 6.1), new THREE.Vector3(4, 1.5, -0.5)],
    ...
    [PLACES.BENCH]: {
        ...
        [PLACES.MUSEUM]: [new THREE.Vector3(0, 1.5, 8), new THREE.Vector3(1.25, 1.5, 6), new THREE.Vector3(4.8, 1.5, -0.2)],
    ...
    [PLACES.PATH]: {
        ...
        [PLACES.MUSEUM]: [new THREE.Vector3(-1.9, 1.5, -4.9), new THREE.Vector3(-0.3, 1.5, -5.95), new THREE.Vector3(3.2, 1.5, -0.2)],
    ...
    [PLACES.MUSEUM]: {
        ...
        [PLACES.LAKE.MUSEUM]: [new THREE.Vector3(3.1, 1.5, 0.05), new THREE.Vector3(6.75, 1.5, 1.35)],
    },
    [PLACES.LAKE.ENTRANCE]: {
        ...
        [PLACES.MUSEUM]: [new THREE.Vector3(-4.65, 1.5, -3.05), new THREE.Vector3(-3.85, 1.5, -5.4), new THREE.Vector3(2.85, 1.5, 0.45)],
    },
    [PLACES.LAKE.BENCH]: {
        ...
        [PLACES.MUSEUM]: [new THREE.Vector3(6.75, 1.5, 7.15), new THREE.Vector3(4.4, 1.5, -0.3)],
    },
    [PLACES.LAKE.PATH]: {
        ...
        [PLACES.MUSEUM]: [new THREE.Vector3(1.65, 1.5, -10.15), new THREE.Vector3(2.05, 1.5, 0.1)],
    },
    [PLACES.LAKE.MUSEUM]: {
        ...
        [PLACES.MUSEUM]: [new THREE.Vector3(5.2, 1.5, 1.25), new THREE.Vector3(3.6, 1.5, 0.85)],
    },
};

export const TRAVELLING_LOOKAT: Positions = {
    [PLACES.ENTRANCE]: {
        [PLACES.BENCH]: [CAMERA_START_POSITION.clone(), new THREE.Vector3(-5, 1.5, 5), CAMERA_BENCH_POSITION.clone().add(new THREE.Vector3(0, -0.2, 1))],
        [PLACES.PATH]: [CAMERA_START_POSITION.clone(), new THREE.Vector3(-7, 1.5, -0.6), new THREE.Vector3(-3.85, 1.5, -3.85), CAMERA_PATH_POSITION.clone().add(new THREE.Vector3(0, 0, -1))],
        [PLACES.MUSEUM]: [CAMERA_START_POSITION.clone(), new THREE.Vector3(-7.4, 1.5, 0.6), new THREE.Vector3(-1.9, 1.5, 8.15), CAMERA_HOUSE_POSITION.clone().add(new THREE.Vector3(1, 0, 0))],
        [PLACES.LAKE.ENTRANCE]: [CAMERA_START_POSITION.clone(), new THREE.Vector3(-1, 0, 2)],
    },
    [PLACES.BENCH]: {
        [PLACES.PATH]: [CAMERA_BENCH_POSITION.clone(), new THREE.Vector3(-6.2, 1.5, 1.35), CAMERA_PATH_POSITION.clone().add(new THREE.Vector3(0, 0, -1))],
        [PLACES.MUSEUM]: [CAMERA_BENCH_POSITION.clone(), new THREE.Vector3(3.6, 1.5, 5), CAMERA_HOUSE_POSITION.clone().add(new THREE.Vector3(1, 0, 0))],
        [PLACES.LAKE.BENCH]: [CAMERA_BENCH_POSITION.clone(), new THREE.Vector3(-1, 0, 2)],
    },
    [PLACES.PATH]: {
        [PLACES.BENCH]: [CAMERA_PATH_POSITION.clone(), new THREE.Vector3(-6.2, 1.5, 1.35), CAMERA_BENCH_POSITION.clone().add(new THREE.Vector3(0, -0.2, 1))],
        [PLACES.MUSEUM]: [CAMERA_PATH_POSITION.clone(), new THREE.Vector3(1.65, 1.5, -4.9), CAMERA_HOUSE_POSITION.clone().add(new THREE.Vector3(1, 0, 0))],
        [PLACES.LAKE.PATH]: [CAMERA_PATH_POSITION.clone(),  new THREE.Vector3(-1, 0, 2)],
    },
    [PLACES.MUSEUM]: {
        [PLACES.BENCH]: [CAMERA_HOUSE_POSITION.clone(), new THREE.Vector3(4.8, 1.5, 4), CAMERA_BENCH_POSITION.clone().add(new THREE.Vector3(0, -0.2, 1))],
        [PLACES.PATH]: [CAMERA_HOUSE_POSITION.clone(), new THREE.Vector3(2.45, 1.5, -3.9), CAMERA_PATH_POSITION.clone().add(new THREE.Vector3(0, 0, -1))],
        [PLACES.LAKE.MUSEUM]: [CAMERA_HOUSE_POSITION.clone(), new THREE.Vector3(-1, 0, 2)],
    },
    [PLACES.LAKE.ENTRANCE]: {
        [PLACES.BENCH]: [CAMERA_LAKE_ENTRANCE_POSITION.clone(), new THREE.Vector3(-5, 1.5, 5.6), CAMERA_BENCH_POSITION.clone().add(new THREE.Vector3(0, -0.2, 1))],
        [PLACES.PATH]: [CAMERA_LAKE_ENTRANCE_POSITION.clone(), CAMERA_PATH_POSITION.clone().add(new THREE.Vector3(0, 0, -1))],
        [PLACES.MUSEUM]: [CAMERA_LAKE_ENTRANCE_POSITION.clone(), new THREE.Vector3(0.1, 1.5, -5.4), CAMERA_HOUSE_POSITION.clone().add(new THREE.Vector3(1, 0, 0))],
    },
    [PLACES.LAKE.BENCH]: {
        [PLACES.BENCH]: [CAMERA_LAKE_BENCH_POSITION.clone(), CAMERA_BENCH_POSITION.clone().add(new THREE.Vector3(0, -0.2, 1))],
        [PLACES.PATH]: [CAMERA_LAKE_BENCH_POSITION.clone(), new THREE.Vector3(-5.8, 1.5, -0.3), CAMERA_PATH_POSITION.clone().add(new THREE.Vector3(0, 0, -1))],
        [PLACES.MUSEUM]: [CAMERA_LAKE_BENCH_POSITION.clone(), CAMERA_HOUSE_POSITION.clone().add(new THREE.Vector3(1, 0, 0))],
    },
    [PLACES.LAKE.PATH]: {
        [PLACES.BENCH]: [CAMERA_LAKE_PATH_POSITION.clone(), new THREE.Vector3(-5.8, 1.5, 3.2), CAMERA_BENCH_POSITION.clone().add(new THREE.Vector3(0, -0.2, 1))],
        [PLACES.PATH]: [CAMERA_LAKE_PATH_POSITION.clone(), CAMERA_PATH_POSITION.clone().add(new THREE.Vector3(0, 0, -1))],
        [PLACES.MUSEUM]: [CAMERA_LAKE_PATH_POSITION.clone(), CAMERA_HOUSE_POSITION.clone().add(new THREE.Vector3(1, 0, 0))],
    },
    [PLACES.LAKE.MUSEUM]: {
        [PLACES.BENCH]: [CAMERA_LAKE_HOUSE_POSITION.clone(), CAMERA_BENCH_POSITION.clone().add(new THREE.Vector3(0, -0.2, 1))],
        [PLACES.PATH]: [CAMERA_LAKE_HOUSE_POSITION.clone(), CAMERA_PATH_POSITION.clone().add(new THREE.Vector3(0, 0, -1))],
        [PLACES.MUSEUM]: [CAMERA_LAKE_HOUSE_POSITION.clone(), CAMERA_HOUSE_POSITION.clone().add(new THREE.Vector3(1, 0, 0))],
    },
};

export const CONTROL_POINTS_LOOKAT: Positions = {
    [PLACES.ENTRANCE]: {
        [PLACES.BENCH]: [new THREE.Vector3(-5, 1.5, 0), new THREE.Vector3(-7.35, 1.5, 2.15), new THREE.Vector3(0, 1.5, 7.65)],
        [PLACES.PATH]: [CAMERA_START_POSITION.clone(), new THREE.Vector3(-7.75, 1.5, -0), new THREE.Vector3(-5.4, 1.5, -2.3), new THREE.Vector3(-2.3, 1.5, -4.7)],
        [PLACES.MUSEUM]: [CAMERA_START_POSITION.clone(), new THREE.Vector3(-9.3, 1.5, -0.3), new THREE.Vector3(-5.8, 1.5, 6.1), new THREE.Vector3(4, 1.5, -0.5)],
