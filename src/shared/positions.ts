...
export const TRAVELLING_LOOKAT: Positions = {
    [PLACES.ENTRANCE]: {
        ...
        [PLACES.HOUSE]: [CAMERA_START_POSITION.clone(), new THREE.Vector3(-7.4, 1.5, 0.6), new THREE.Vector3(-1.9, 1.5, 8.15), CAMERA_HOUSE_POSITION.clone().add(new THREE.Vector3(1, 0, 0))],
        [PLACES.LAKE.ENTRANCE]: [CAMERA_START_POSITION.clone(), CAMERA_LAKE_ENTRANCE_POSITION.clone().add(new THREE.Vector3(1, 0, 0))],
    },
    [PLACES.BENCH]: {
        ...
        [PLACES.HOUSE]: [CAMERA_BENCH_POSITION.clone(), new THREE.Vector3(3.6, 1.5, 5), CAMERA_HOUSE_POSITION.clone().add(new THREE.Vector3(1, 0, 0))],
        [PLACES.LAKE.BENCH]: [CAMERA_BENCH_POSITION.clone(), CAMERA_LAKE_BENCH_POSITION.clone().add(new THREE.Vector3(0, 0, -1))],
    },
    [PLACES.PATH]: {
        ...
        [PLACES.HOUSE]: [CAMERA_PATH_POSITION.clone(), new THREE.Vector3(1.65, 1.5, -4.9), CAMERA_HOUSE_POSITION.clone().add(new THREE.Vector3(1, 0, 0))],
        [PLACES.LAKE.PATH]: [CAMERA_PATH_POSITION.clone(), CAMERA_LAKE_PATH_POSITION.clone().add(new THREE.Vector3(0, 0, 1))],
    },
    [PLACES.HOUSE]: {
        ...
        [PLACES.LAKE.HOUSE]: [CAMERA_HOUSE_POSITION.clone(), CAMERA_LAKE_HOUSE_POSITION.clone().add(new THREE.Vector3(-1, 0, 0))],
    },
    [PLACES.LAKE.ENTRANCE]: {
        ...
        [PLACES.HOUSE]: [CAMERA_LAKE_ENTRANCE_POSITION.clone(), new THREE.Vector3(0.1, 1.5, -5.4), CAMERA_HOUSE_POSITION.clone().add(new THREE.Vector3(1, 0, 0))],
    },
    [PLACES.LAKE.BENCH]: {
        ...
        [PLACES.HOUSE]: [CAMERA_LAKE_BENCH_POSITION.clone(), CAMERA_HOUSE_POSITION.clone().add(new THREE.Vector3(1, 0, 0))],
    },
    [PLACES.LAKE.PATH]: {
        ...
        [PLACES.HOUSE]: [CAMERA_LAKE_PATH_POSITION.clone(), CAMERA_HOUSE_POSITION.clone().add(new THREE.Vector3(1, 0, 0))],
    },
    [PLACES.LAKE.HOUSE]: {
        ...
        [PLACES.HOUSE]: [CAMERA_LAKE_HOUSE_POSITION.clone(), CAMERA_HOUSE_POSITION.clone().add(new THREE.Vector3(1, 0, 0))],
    },
};
